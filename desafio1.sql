...
CREATE TABLE usuarios(
  ...
  CONSTRAINT FOREIGN KEY (id_plano) REFERENCES planos(id)
)ENGINE=InnoDB;
...
CREATE TABLE musicas(
  ...
  CONSTRAINT FOREIGN KEY (id_album) REFERENCES albuns(id)
)ENGINE=InnoDB;
...
CREATE TABLE historicoUsuario(
    ...
    CONSTRAINT FOREIGN KEY (id_usuario) REFERENCES usuarios(id),
    CONSTRAINT FOREIGN KEY (id_musica) REFERENCES musicas(id)
) ENGINE=InnoDB;
...
INSERT INTO albuns(nome, id_artista, ano_lancamento )
...
INSERT INTO usuarios(nome, idade, id_plano,data_assinatura)
...
INSERT INTO musicas(nome, id_album, duracao_segundos)
...
INSERT INTO historicoUsuario(id_usuario, id_musica, data_reproducao) 
